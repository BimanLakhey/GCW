...
namespace GCW.Controllers
{
    ...
    public class DVDCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryNumber,CategoryDescription,AgeRestriction")] DVDCategory dVDCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryNumber,CategoryDescription,AgeRestriction")] DVDCategory dVDCategory)
        {
